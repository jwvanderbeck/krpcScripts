...
class Operations:
    ...
    def __init__(self, target_orbit, target_inc):
        # super().__init__()
        self.conn = krpc.connect(name = "Operations", address="10.0.1.10", rpc_port=50000, stream_port=50001)
        ...
        self.target_orbit_alt = target_orbit
        self.target_orbit_inc = target_inc
